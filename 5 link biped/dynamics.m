...
% write_fcn(['fcn_dynamics_auto.m'],{'q'},[list_q_e],{G,'G';D,'D';C,'C';J,'J';v2v,'v2v';});
write_fcn('D_q_m.m',{'q'},[list_q_e],{D,'D'});
write_fcn('C_q_m.m',{'q','dq'},[list_q_e],{C,'C'});
write_fcn('G_q_m.m',{'q'},[list_q_e],{G,'G'});
end